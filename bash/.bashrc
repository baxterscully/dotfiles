...
alias la='ls -A'
alias l='ls -CF'
alias sdot='pushd $HOME/dotfiles/ && stow . && popd'
...
# Turn off the dumbass bell sound
...
auto-switch-node-version-bash() {
    auto-switch-node-version
}

PROMPT_COMMAND="auto-switch-node-version-bash; $PROMPT_COMMAND"
...
__conda_setup="$('/home/baxter/miniforge3/bin/conda' 'shell.bash' 'hook' 2> /dev/null)"
if [ $? -eq 0 ]; then
    eval "$__conda_setup"
else
